namespace SrcSinavUygulamasi.Models
{
    public class ExamModel
    {
        ...
        public int QuestionCount { get; set; }   // Bu denemede kaç soru (genelde 20)
        ...
        public double PointsPerQuestion { get; set; } = 5;  // Her soru kaç puan
        public string Subtitle { get; set; }     // Alt başlık (örn: "100 Puan · 70+ Geçer")
    }
}
